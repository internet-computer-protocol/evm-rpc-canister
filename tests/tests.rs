...
impl EvmRpcSetup {
    ...
    pub fn eth_get_logs(
        ...
        self.call_update("eth_getLogs", Encode!(&source, &args, &config).unwrap())
    }
    ...
    pub fn eth_get_block_by_number(
        ...
        self.call_update(
            ...
            Encode!(&source, &block, &config).unwrap(),
        )
    }
    ...
    pub fn eth_get_transaction_receipt(
        ...
        self.call_update(
            ...
            Encode!(&source, &address, &config).unwrap(),
        )
    }
    ...
    pub fn eth_get_transaction_count(
        ...
        self.call_update(
            ...
            Encode!(&source, &args, &config).unwrap(),
        )
    }
    ...
    pub fn eth_fee_history(
        ...
        self.call_update("eth_feeHistory", Encode!(&source, &args, &config).unwrap())
    }
    ...
    pub fn eth_send_raw_transaction(
        ...
        self.call_update(
            ...
            Encode!(&source, &signed_raw_transaction_hex, &config).unwrap(),
        )
    }
}
